...
class Sample : public ShaderExample {
  ...
  virtual bool Initialize( WindowParameters WindowParameters ) override {
    ...
    // Vertex data
    if( !Load3DModelFromObjFile( "C:/Users/timon/source/repos/VulkanCppWindowedProgram1/AdvExamples/3DRendering/data/Models/knot.obj", true, false, false, true, Model ) ) {
      return false;
    }
    ...
    if( !GetBinaryFileContents( "C:/Users/timon/source/repos/VulkanCppWindowedProgram1/AdvExamples/3DRendering/data/Shaders/11 Lighting/01 Rendering a geometry with vertex diffuse lighting/shader.vert.spv", vertex_shader_spirv ) ) {
      return false;
    }
    ...
    if( !GetBinaryFileContents( "C:/Users/timon/source/repos/VulkanCppWindowedProgram1/AdvExamples/3DRendering/data/Shaders/11 Lighting/01 Rendering a geometry with vertex diffuse lighting/shader.frag.spv", fragment_shader_spirv ) ) {
      return false;
    }
...
VULKAN_SAMPLE_FRAMEWORK( "Rendering a geometry with vertex diffuse lighting", 50, 25, 1280, 800, Sample )
