...
namespace VulkanLibrary {
  ...
  WindowFramework::WindowFramework( const char               * window_title,
    ...
    WNDCLASSEX window_class = {
      ...
      TEXT("VulkanLibrary"),                 // LPCSTR       lpszClassName
                                        /* Win 4.0 */
    ...
    WindowParameters.HWnd = CreateWindow( TEXT("VulkanLibrary"), TEXT("Test"), WS_OVERLAPPEDWINDOW | WS_MAXIMIZE, x, y, width, height, nullptr, nullptr, WindowParameters.HInstance, nullptr );
  ...
  WindowFramework::~WindowFramework() {
    ...
    if( WindowParameters.HInstance ) {
      UnregisterClass( TEXT("VulkanLibrary"), WindowParameters.HInstance );
    }
  }
