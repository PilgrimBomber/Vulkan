...
class Sample : public ShaderExample {
	...
	virtual bool Initialize(WindowParameters WindowParameters) override {
		...
		if (!LoadTextureDataFromFile("C:/Users/timon/source/repos/VulkanCppWindowedProgram1/AdvExamples/RenderingTexture/data/Textures/normal_map.png", 4, image_data, &width, &height)) {
			return false;
		}
		...
		if (!Load3DModelFromObjFile("C:/Users/timon/source/repos/VulkanCppWindowedProgram1/AdvExamples/RenderingTexture/data/Models/ice.obj", true, true, true, true, Model, &vertex_stride)) {
			return false;
		}
		...
		if (!GetBinaryFileContents("C:/Users/timon/source/repos/VulkanCppWindowedProgram1/AdvExamples/RenderingTexture/data/Shaders/11 Lighting/03 Rendering a normal mapped geometry/shader.vert.spv", vertex_shader_spirv)) {
			return false;
		}
		...
		if (!GetBinaryFileContents("C:/Users/timon/source/repos/VulkanCppWindowedProgram1/AdvExamples/RenderingTexture/data/Shaders/11 Lighting/03 Rendering a normal mapped geometry/shader.frag.spv", fragment_shader_spirv)) {
			return false;
		}
...
VULKAN_SAMPLE_FRAMEWORK("Rendering a normal mapped geometry", 50, 25, 1280, 800, Sample)
