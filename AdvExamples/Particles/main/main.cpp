...
class Sample : public ShaderExample {
	...
	virtual bool Initialize(WindowParameters WindowParameters) override {
		...
		if (!GetBinaryFileContents("C:/Users/timon/source/repos/VulkanCppWindowedProgram1/AdvExamples/Particles/data/Shaders/12 Advanced Rendering Techniques/03 Drawing particles using compute and graphics pipelines/shader.comp.spv", compute_shader_spirv)) {
			return false;
		}
		...
		if (!GetBinaryFileContents("C:/Users/timon/source/repos/VulkanCppWindowedProgram1/AdvExamples/Particles/data/Shaders/12 Advanced Rendering Techniques/03 Drawing particles using compute and graphics pipelines/shader.vert.spv", vertex_shader_spirv)) {
			return false;
		}
		...
		if (!GetBinaryFileContents("C:/Users/timon/source/repos/VulkanCppWindowedProgram1/AdvExamples/Particles/data/Shaders/12 Advanced Rendering Techniques/03 Drawing particles using compute and graphics pipelines/shader.geom.spv", geometry_shader_spirv)) {
			return false;
		}
		...
		if (!GetBinaryFileContents("C:/Users/timon/source/repos/VulkanCppWindowedProgram1/AdvExamples/Particles/data/Shaders/12 Advanced Rendering Techniques/03 Drawing particles using compute and graphics pipelines/shader.frag.spv", fragment_shader_spirv)) {
			return false;
		}
